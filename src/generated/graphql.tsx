...
export type RocketQueryVariables = {
  id: Scalars["String"];
};

export type RocketQuery = { __typename?: "Query" } & {
  rocket: Maybe<
    ...
    > & {
        first_stage: Maybe<
          { __typename?: "RocketFirstStage" } & Pick<
            RocketFirstStage,
            "fuel_amount_tons"
          >
        >;
        second_stage: Maybe<
          { __typename?: "RocketSecondStage" } & Pick<
            RocketSecondStage,
            "fuel_amount_tons"
          >
        >;
        height: Maybe<{ __typename?: "Dimension" } & Pick<Dimension, "meters">>;
        diameter: Maybe<
          { __typename?: "Dimension" } & Pick<Dimension, "meters">
        >;
  ...
  rockets: Maybe<
    Array<
      Maybe<
        { __typename?: "Rocket" } & Pick<
          Rocket,
          "first_flight" | "country" | "rocket_name" | "rocket_id"
        >
      >
    >
  >;
...
export const RocketComponent = (
  props: Omit<
    Omit<ReactApollo.QueryProps<RocketQuery, RocketQueryVariables>, "query">,
    "variables"
  > & { variables: RocketQueryVariables }
) => (
  <ReactApollo.Query<RocketQuery, RocketQueryVariables>
    query={RocketDocument}
    {...props}
  />
);

export type RocketProps<TChildProps = {}> = Partial<
  ReactApollo.DataProps<RocketQuery, RocketQueryVariables>
> &
  TChildProps;
export function withRocket<TProps, TChildProps = {}>(
  operationOptions?: ReactApollo.OperationOption<
    TProps,
    RocketQuery,
    RocketQueryVariables,
    RocketProps<TChildProps>
  >
) {
  return ReactApollo.withQuery<
    ...
    RocketQueryVariables,
    RocketProps<TChildProps>
  >(RocketDocument, operationOptions);
}

export function useRocketQuery(
  baseOptions?: ReactApolloHooks.QueryHookOptions<RocketQueryVariables>
) {
  return ReactApolloHooks.useQuery<RocketQuery, RocketQueryVariables>(
    RocketDocument,
    baseOptions
  );
}
